...
Go to https://policy-public.kpnnet.org for the latest KPN Security Policy.
...
1. The KPN Security Policy is featured in a public website all external users, suppliers, customers, etc.
    * The site is located at: https://policy-public.kpnnet.org
...
3. For KPN employees:
    ...
    * On TeamKPN: select KPN and Security on the navigation bar or use https://policy.kpnnet.org through the VPN or over the corporate intranet.
